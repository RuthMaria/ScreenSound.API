...
internal class MenuMostrarMusicasPorAno : Menu
{
    public override void Executar(DAL<Artista> artistaDAL)
    {
        ...
        /* 
         Use Convert.ToInt32 se você estiver lidando com entradas que podem ser null ou de tipos variados (como bool, object, etc.). 
         Se o valor for null, retorna 0.
         Use int.Parse quando estiver trabalhando exclusivamente com strings e tiver certeza de que a entrada será válida e não null.
        */
